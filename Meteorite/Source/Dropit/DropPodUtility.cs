...
namespace RimWorld{
public class DropPodInfo : Saveable
{
...
public static class DropPodUtility
{
	...
	public static void DropThingsNear( IntVec3 dropCenter, IEnumerable<Thing> things, int openDelay = DropPodInfo.DefaultOpenDelay, bool canInstaDropDuringInit = true, bool leaveSlag = false )
	{
